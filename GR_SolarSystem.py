...
for body in bodies_list:
    ...
    d_theta[body] = 0
    d_phi[body] = 0
    distances_direction[body] = [1, 1, 1]
...
'''
Spherical Differentiation Objects
'''
...
for object in bodies_list:
    if object != 'sun':
        geodesic[object] = Geodesic(body=body_obj[object], time=0 * u.s, end_lambda=end_lambda, step_size=stepsize)


sgp = StaticGeodesicPlotter()
sgp.animate(geodesic['earth'], interval=5)
sgp.show()
